...
public class SplashActivity extends AwesomeSplash {
    ...
    public void animationsFinished() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashActivity.this, MovieDashboardActivity.class);
    ...
    public void getAndSetSplashValues(ConfigSplash configSplash) {
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.bottom_image); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("CODE TO ART");
